...
import type { CopySymbolUseCase } from '../domain/usecases/CopySymbolUseCase';
import type { SearchSymbolsUseCase } from '../domain/usecases/SearchSymbolsUseCase';
import { symbolFilterCategories, type SymbolFilterCategory } from '../domain/models/SymbolCategory';
...
export class SymbolFinderPage extends HTMLElement {
  ...
  private renderChip(category: SymbolFilterCategory): string {
    ...
    return `
      <md-filter-chip
        label="${this.escapeAttribute(category)}"
